...
function GoogleCallbackContent() {
  ...
  const setAuthFromToken =
    auth?.setAuthFromToken || auth?.loginWithToken || null;
  ...
  useEffect(() => {
    ...
    const next =
      sp.get("next") || localStorage.getItem("postLoginRedirect") || "/";
    ...
    const hashToken = hashTokenMatch
      ? decodeURIComponent(hashTokenMatch[1])
      : null;
